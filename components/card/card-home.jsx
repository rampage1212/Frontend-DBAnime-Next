                ...
                <div key={result.id}>
                    ...
                    <div className="max-w-md mx-auto hover:shadow-xl overflow-hidden md:max-w-7xl rounded-3xl">
                        <div className="md:flex">
                            ...
                            <div className="p-8">
                                <div className="tracking-wide text-sm text-indigo-500 font-semibold capitalize">will be released on: {moment(result.aired.from).format("ddd, DD-M-YYYY")}</div>
                                <a href={result.url} rel="noreferrer" target="_blank" className="block mt-2 text-xl leading-tight font-medium transition duration-500 ease-in-out text-black capitalize">{result.title}</a>
